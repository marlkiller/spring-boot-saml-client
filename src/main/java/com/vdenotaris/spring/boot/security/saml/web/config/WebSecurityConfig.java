...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    @Bean
    public ExtendedMetadataDelegate privateSAMLMetadataProvider()
            throws MetadataProviderException {
        String idpSSOCircleMetadataURL = "https://saml-dev.authing.cn/api/v2/saml-idp/6389e736d3c2d4fde08a1d18/metadata";
        HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(
                this.backgroundTaskTimer, httpClient(), idpSSOCircleMetadataURL);
        httpMetadataProvider.setParserPool(parserPool());
        ExtendedMetadataDelegate extendedMetadataDelegate =
    ...
    public CachingMetadataManager metadata() throws MetadataProviderException {
        ...
        providers.add(privateSAMLMetadataProvider());
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId("com:marlkiller:spring:sp");
